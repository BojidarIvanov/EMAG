...
h3 {
	...
	<h3 align="center"; >
		Take advantage of hot offers, the prices were never so attractive !
		</h1>
		...
		<div class="wrap">
			<ul class="grid grid-sm-2 grid-lg-4">
				<li>
					<div class="cat-item">
						<div class="item-header">
							<a href="" class="item-img"> <img src="image/Cisco.jpg"
								alt="" /> <!--  	</a> <a href="" class="item-img-zoom btn btn-secondary btn-circle"
				...
				<li>
					<div class="cat-item">
						<div class="item-header">
							<a href="" class="item-img"> <img src="image/Dell.jpg" alt="" />
							</a> <!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
								title="Zoom In"> <span class="fa fa-search-plus"></span> 
							</a> -->
						</div>
						<div class="item-body">
							...
							<div class="item-price h4">$9000 лв.</div>
						</div>
							<a href="" class="btn btn-primary btn-expanded">Добави в количка</a>
					</div>
				</li> 
						<li>
							<div class="cat-item">
								<div class="item-header">
											<a href="" class="item-img"> <img src="image/Logitech.jpg"
								alt="" />
							</a>  
						...
						<li>
							<div class="cat-item">
								<div class="item-header">
									<a href="" class="item-img"> <img src="image/Elysee.jpg"
										alt="" />
									</a>
									<!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
								title="Zoom In"> <span class="fa fa-search-plus"></span>
						...
						<li>
							<div class="cat-item">
								<div class="item-header">
									<a href="" class="item-img"> <img src="image/Hermes.jpg"
										alt="" />
									</a>
									<!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
								title="Zoom In"> <span class="fa fa-search-plus"></span>
						...
						<li>
							<div class="cat-item">
								<div class="item-header">
									<a href="" class="item-img"> <img src="image/Swatch.jpg"
										alt="" />
									</a> <!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
										title="Zoom In"> <span class="fa fa-search-plus"></span>
									</a> -->
								...
								<div class="item-body">
									...
									<div class="item-price h4">$10.99 - $12.99</div>
								</div>
								<a href="" class="btn btn-primary btn-expanded">Добави в
									количка</a>
							</div>
						...
						<li>
							<div class="cat-item">
								<div class="item-header">
									<a href="" class="item-img"> <img src="image/Casio.jpg"
										alt="" />
									</a>  <!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
										title="Zoom In"> <span class="fa fa-search-plus"></span>
									</a> -->
						...
						<li>
							<div class="cat-item">
								<div class="item-header">
									<a href="" class="item-img"> <img src="image/Citizen.jpg"
										alt="" />
									</a> <!-- <a href="" class="item-img-zoom btn btn-secondary btn-circle"
										title="Zoom In"> <span class="fa fa-search-plus"></span>
									</a> -->
			...
			<div class="overlay-wrap">
				<a href="" class="btn btn-secondary btn-circle overlay-close"> <span
					class="fa fa-times-circle-o"></span>
				</a>
				<div class="overlay item-preview">
					<div class="preview-img">
						<div class="slider">
							<div>
								<img src="http://placehold.it/327x350/227dd5/fff" alt="" />
							</div>
							<div>
								<img src="http://placehold.it/327x350/22d57b/fff" alt="" />
							</div>
							<div>
								<img src="http://placehold.it/327x350/3e22d5/fff" alt="" />
							</div>
							<div>
								<img src="http://placehold.it/327x350/d57922/fff" alt="" />
							</div>
						</div>
					</div>
					<div class="preview-body">
						...
						<div class="preview-price h4">$10.99 - $12.99</div>
						<div class="row">
							...
							<div class="col col-lg-1-4">
								<label for="qty">Quantity</label> <input type="number" min="0"
									max="25" name="qty" />
							</div>
						</div>
